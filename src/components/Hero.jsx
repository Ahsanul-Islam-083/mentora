                            ...
                            <div className="space-y-8 text-center lg:text-left">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center lg:justify-start">
                                    ...
                                    <Button
                                        href="/courses"
                                        size="lg"
                                        className="h-14 px-10 text-lg font-bold rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-all duration-300 shadow-xl shadow-blue-500/30 group border border-blue-500 flex justify-center items-center cursor-pointer"
                                    >
                                        Explore Courses
                                    ...
                                    <Button
                                        variant="bordered"
                                        size="lg"
                                        className="h-14 px-8 text-lg font-bold rounded-full border-2 border-slate-300 bg-white/80 backdrop-blur text-slate-800 hover:bg-slate-100 hover:border-blue-400 transition-all duration-300 group flex justify-center items-center cursor-pointer"
                                    >
